...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies__repo_css: string;
	...
	export const npm_package_devDependencies__vercel_og: string;
	...
	export const npm_package_devDependencies__fontsource_variable_raleway: string;
	...
	export const npm_package_devDependencies__fontsource_variable_inconsolata: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies__repo_css: string;
		VOLTA_HOME: string;
		...
		COMMAND_MODE: string;
		npm_package_devDependencies__vercel_og: string;
		...
		npm_package_devDependencies__fontsource_variable_raleway: string;
		PWD: string;
		...
		npm_package_devDependencies__fontsource_variable_inconsolata: string;
		LOGNAME: string;
