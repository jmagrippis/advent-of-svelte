...
it('returns the amount of months between two dates', () => {
	...
	const resultA = getTimeDifference(dateA, christmas)
	expect(resultA.months).toBe(1)

	const dateB = new Date('2023-10-19')

	const resultB = getTimeDifference(dateB, christmas)
...
it('returns the amount of days between two dates', () => {
	...
	const dateA = new Date('2023-12-17T00:00:00.000Z')

	const resultA = getTimeDifference(christmas, dateA)
	expect(resultA.days).toBe(-8)

	const dateB = new Date('2023-12-24T00:00:00.000Z')
...
it('returns 0 when it has not been a full minute', () => {
	const christmas = new Date('2023-12-25T00:00:00.000Z')
	const dateA = new Date('2023-12-24T23:59:40.000Z')

	const resultA = getTimeDifference(dateA, christmas)
	expect(resultA.minutes).toBe(0)

	const dateB = new Date('2023-12-24T23:59:01.000Z')

	const resultB = getTimeDifference(dateB, christmas)
	expect(resultB.minutes).toBe(0)
})
