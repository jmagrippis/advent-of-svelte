<script lang="ts">
	...
	import PlayMorse from './PlayMorse.svelte'
...
<section class="flex flex-col gap-4">
	<label class="flex flex-col gap-4 text-xl font-medium leading-6">
...
{#if morseCode}
	<p
		class="breakout mb-4 flex flex-wrap items-baseline gap-4 text-4xl font-black tracking-widest"
	>
